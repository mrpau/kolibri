...
CMD cd /kolibri && pip install --upgrade gcloud && pip install -r requirements/dev.txt && pip install -r requirements/build.txt && yarn install && make dist && cp /kolibri/dist/* /kolibridist/